...
import com.bignerdranch.android.driversroute.room.RouteDatabase
    ...
    companion object {
        ...
        fun getRouteDataBase(): RouteDatabase {
            if (routeDatabase == null) {
                ...
                ).allowMainThreadQueries().build()  //FIX .allowMainThreadQueries() дает в главном потоке делать запрос надо обойти команду эту
            }
